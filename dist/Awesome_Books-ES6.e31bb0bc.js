...
var Storage = /*#__PURE__*/function () {
  ...
  _createClass(Storage, null, [{
    key: "addToStorage",
    value: function addToStorage(books) {
      var storage = localStorage.setItem('books', JSON.stringify(books));
      return storage;
    }
  }, {
    key: "getFromStorage",
    value: function getFromStorage() {
      var storage = localStorage.getItem('books') === null ? [] : JSON.parse(localStorage.getItem('books'));
      return storage;
    }
  }]);
  return Storage;
...
function _toPrimitive(input, hint) { if (_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
var Book = /*#__PURE__*/_createClass(function Book(id, title, author, count) {
...
},{}],"modules/library.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.addNewBook = exports.UI = void 0;
...
var books = _storage.default.getFromStorage();
var count = 1;
  ...
  _createClass(UI, null, [{
    ...
    value: function removeBook() {
      ...
      booksDiv.addEventListener('click', function (e) {
        ...
        _this.deleteBook(e.target.parentElement.getAttribute('data-id'));
      });
    }
  }, {
    key: "deleteBook",
    value: function deleteBook(bookID) {
      ...
      _storage.default.addToStorage(books);
    }
  }]);
  return UI;
}();
exports.UI = UI;
var addNewBook = function addNewBook() {
  if (title.value !== '' && author.value !== '') {
    var id = Date.now();
    var book = new _book.default(id, title.value, author.value, count);
    books.push(book);
    title.value = '';
    author.value = '';
    UI.displayData();
...
},{"./storage.js":"modules/storage.js","./book.js":"modules/book.js"}],"node_modules/luxon/build/cjs-browser/luxon.js":[function(require,module,exports) {
'use strict';
...
exports.Zone = Zone;
},{}],"modules/display date.js":[function(require,module,exports) {
"use strict";
...
function _toPropertyKey(arg) { var key = _toPrimitive(arg, "string"); return _typeof(key) === "symbol" ? key : String(key); }
function _toPrimitive(input, hint) { if (_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
var displayDate = /*#__PURE__*/function () {
  function displayDate() {
    _classCallCheck(this, displayDate);
  }
  _createClass(displayDate, null, [{
    key: "display",
    value: function display() {
      var now = _luxon.DateTime.now().c;
      var date = "".concat(now.year, "-").concat(now.month, "-").concat(now.day);
      var time = "".concat(now.hour, ":").concat(now.minute, ":").concat(now.second);
...
},{"luxon":"node_modules/luxon/build/cjs-browser/luxon.js"}],"modules/display sections.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.displayList = exports.displayContact = exports.displayAdd = void 0;
var _displayDate = _interopRequireDefault(require("./display date.js"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var displayList = function displayList() {
  var addNew = document.querySelector('.add-section');
  ...
  _displayDate.default.display();
};
exports.displayList = displayList;
var displayAdd = function displayAdd() {
  var list = document.querySelector('.books');
...
},{"./display date.js":"modules/display date.js"}],"index.js":[function(require,module,exports) {
"use strict";

var _library = require("./modules/library.js");
var _displaySections = require("./modules/display sections.js");
var add = document.querySelector('.add');
var list = document.getElementById('list');
var addNew = document.getElementById('add-book');
var contact = document.getElementById('contact');
list.addEventListener('click', _displaySections.displayList);
addNew.addEventListener('click', _displaySections.displayAdd);
contact.addEventListener('click', _displaySections.displayContact);
add.addEventListener('click', _library.addNewBook);
window.addEventListener('DOMContentLoaded', function () {
  _library.UI.displayData();
  _library.UI.removeBook();
  (0, _displaySections.displayList)();
});
},{"./modules/library.js":"modules/library.js","./modules/display sections.js":"modules/display sections.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/Awesome_Books-ES6.e31bb0bc.js.map